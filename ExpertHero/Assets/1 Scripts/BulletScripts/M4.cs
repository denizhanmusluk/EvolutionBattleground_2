...
public class M4 : MonoBehaviour, IBullet
{
    ...
    IEnumerator targetFollow()
    {
        while (targetZom != null)
        {
            ...
            {
                transform.position = Vector3.MoveTowards(transform.position, targetZom.transform.position + new Vector3(0, 1, 0), 120 * Time.deltaTime);
